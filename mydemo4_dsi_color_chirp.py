...
good_cells=(var_idx<.788)#&( var_idx>0.6)
...
ax = plt.subplot(121)
s_labels = ('Full field','Chirp','Chirp_color')
...
if SAVE_FIGS:
    plt.savefig('clusters_comparison_mixed.pdf', bbox_inches='tight')    
...
if SAVE_FIGS:
    plt.savefig('clusters_MI_mixed.pdf', bbox_inches='tight')    
...
sorted_normed_cnf, res_order, res_linkage = compute_serial_matrix(SPIKE_dist_ys_valid[2],method='ward')
with plt.rc_context(rcParams):
    plt.figure(figsize=(3,3))
...
if SAVE_FIGS:
    plt.savefig('clusters_distance_matrix_clustered_SPIKE_mixed.pdf', bbox_inches='tight')    
...
if SAVE_FIGS:
    plt.savefig('clusters_summary_chirp_color_SPIKE_mixed.pdf', bbox_inches='tight')
