...
if LOAD_STORED_DISTANCES == False:
    ...
    np.save('SPIKE_dist_ys_5',SPIKE_dist_ys)
    np.save('ISI_dist_ys_5',ISI_dist_ys)
else:
    SPIKE_dist_ys = np.load('SPIKE_dist_ys_5.npy')
    ISI_dist_ys   = np.load('ISI_dist_ys_5.npy')
...
if SAVE_FIGS:
    plt.savefig('clusters_distance_matrix_clustered_SPIKE_mixed_5.pdf', bbox_inches='tight')    
...
if SAVE_FIGS:
    plt.savefig('clusters_summary_chirp_color_SPIKE_mixed_5.pdf', bbox_inches='tight')
...
if SAVE_FIGS:
    plt.savefig('clusters_tsne_chirp_SPIKE_5.pdf', bbox_inches='tight')