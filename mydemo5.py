# -*- coding: utf-8 -*-
"""
Created on Mon Apr 20 13:55:31 2020
...
# -*- coding: utf-8 -*-
"""
Created on Sat Apr 18 11:34:14 2020
...
# -*- coding: utf-8 -*-
"""
Created on Wed Apr 15 12:00:35 2020
...
filenames=['2019_07_17_mrg','2019_07_16_lw.mat']#,'2020_02_04_l1_before.mat','2020_02_06_r1_before.mat','2020_01_25_left.mat','2020_01_16_wl.mat']
...
report_filenames  = [ data_path+"2019_07_17_mrg_report_old.txt",data_path+"2019_07_16_lw_report.txt"] 
...
trigger_filenames = [ data_path+"trigger_2019_07_17_mrg.mat",data_path+"2019_07_16_lw_trigger.mat"] 
                    # ,data_path+"trigger_2020_02_04_l1_before.mat" ,data_path+"trigger_2020_02_06_r1_before.mat"
...
MIN_SPIKES_CHIRP = 50# min spikes in Chirp stimulus
...
empty_trials[1] = np.asarray([np.min([len(s) for s in st])<MIN_SPIKES_CHIRP for st in Stimuli['SpikeTrains'][1]])
...
ntrials = len(Stimuli['SpikeTrains'][istim][0])
...
#    np.save('SPIKE_dist_ys',SPIKE_dist_ys)
#    np.save('ISI_dist_ys',ISI_dist_ys)
else:
    SPIKE_dist_ys = np.load('SPIKE_dist_ys.npy')
    ISI_dist_ys   = np.load('ISI_dist_ys.npy')
...
#%%
ds_stim={}
ds_stim['SpikeTrains'] = Stimuli['SpikeTrains'][2:]
...
plot_widths = [1.2,.8,3,0.4,0.4, 0.4, 0.3]
...
for i, c in enumerate(show_order):
    ...
    for ci, stimid in enumerate(plot_stims):
        ...
        with plt.rc_context({'font.size':fs, 'axes.titleweight': 'bold'}):
            ...
            plotPSTHs(ax,sts.flatten(),txt,bins,palette[c], show_sd=False, lw=1)
            plt.xticks(())
            plt.yticks(())
            ax.spines['top'].set_visible(False)
