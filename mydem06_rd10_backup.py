...
"""
import sys
sys.path.append('C:/Users/Admin/PySpike')
...
#%% function to remove low quality data
...
#%% function2 to remove low quality data
...
#%% before blocker
from spk_trains_maker import spk_trains_maker
filenames=['2020_02_07_rd10_l1_before.mat','2020_02_07_rd10_r1_before.mat','2020_02_05_rd10_l1_before.mat','2020_02_05_rd10_r1_before.mat']
...
plot_stims=[0,1]     
plot_psd=True  
frq_table_b=eata_clustsering(Stimuli,fcls_sta,conditions_all,esta_all,psd_all_before,freqsl,Cell_names,plot_stims,t,'rd10_Before_shortsta2',OOi,plot_psd,SAVE_FIGS)
...
t=cluster_number
plot_stims=[0]       
frq_table_a=eata_clustsering(flash_stimuli,fcls_sta,conditions_all,esta_all_rd_after,psd_all_after,freqsl,Cell_names_rd_after,plot_stims,t,'rd10_After_shortsta2',OOi,plot_psd,SAVE_FIGS)
