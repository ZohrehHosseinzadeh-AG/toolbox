...
if LOAD_STORED_DISTANCES == False:
    ...
    np.save('SPIKE_dist_ys_rd10_neworder_before',SPIKE_dist_ys)
    np.save('ISI_dist_ys_rd10_neworder_before',ISI_dist_ys)
else:
    SPIKE_dist_ys = np.load('SPIKE_dist_ys_rd10_neworder_before.npy')
    ISI_dist_ys   = np.load('ISI_dist_ys_rd10_neworder_before.npy')
...
ax = plt.subplot(121)
s_labels = ('Full field','Color','Flash_color')
...
if SAVE_FIGS:
    plt.savefig('clusters_comparison_rd10_neworder_before.pdf', bbox_inches='tight')    
...
if SAVE_FIGS:
    plt.savefig('clusters_MI_rd10_neworder_before.pdf', bbox_inches='tight')    
...
if SAVE_FIGS:
    plt.savefig('clusters_distance_matrix_clustered_SPIKE_rd10_neworder_before.pdf', bbox_inches='tight')    
...
new_distances=SPIKE_dist_ys_valid[2]
...
if SAVE_FIGS:
    plt.savefig('clustered_dendrogram rd10_neworder_before.pdf', bbox_inches='tight')    
...
if SAVE_FIGS:
    plt.savefig('clusters_summary_chirp_color_SPIKE_rd10_neworder_before_new.pdf', bbox_inches='tight')
...
plot_clustrs(flash_stimuli,fcls,OOi,conditions_all,esta_all_rd_after,Cell_names_rd_after,plot_stims,'After2')
...
plot_clustrs(flash_stimuli_before,fcls,OOi,conditions_all,esta_all,Cell_names,plot_stims,'Before2')
...
if SAVE_FIGS:
    plt.savefig('clusters_tsne_chirp_SPIKE_rd10_neworder_before.pdf', bbox_inches='tight')
#
#%% PCA
st_name='Flash'
...
if SAVE_FIGS:
   plt.savefig('clusters_e_STA_color_mixed_rd10_neworder_before.pdf', bbox_inches='tight')
...
t=cluster_number
plot_stims=[0,1]       
eata_clustsering(Stimuli,fcls,conditions_all,esta_all,Cell_names,plot_stims,t,'Before1')

 
t=cluster_number
plot_stims=[0]       
eata_clustsering(flash_stimuli,fcls,conditions_all,esta_all_rd_after,Cell_names_rd_after,plot_stims,t,'After1')
