...
if LOAD_STORED_DISTANCES == False:
    ...
    np.save('SPIKE_dist_ys_rd10',SPIKE_dist_ys)
    np.save('ISI_dist_ys_rd10',ISI_dist_ys)
else:
...
if SAVE_FIGS:
    plt.savefig('clusters_distance_matrix_clustered_SPIKE_rd10.pdf', bbox_inches='tight')    
...
if SAVE_FIGS:
    plt.savefig('clusters_summary_chirp_color_SPIKE_rd10.pdf', bbox_inches='tight')
...
if SAVE_FIGS:
   plt.savefig('clusters_e_STA_color_mixed_rd10.pdf', bbox_inches='tight')
